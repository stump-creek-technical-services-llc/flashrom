 ...
 */

	{
		 ...
		 * https://github.com/stump-creek-technical-services-llc/
		 ...
		 * but they're actually 0x0E, 0x4015. I don't know why.
		 */
		 ...
		 *
		 * The voltage range varies by frequency.
		 * This is for 104 MHz, fR=45 MHz.
		 */
		.voltage	= {2700, 3600},
	},
